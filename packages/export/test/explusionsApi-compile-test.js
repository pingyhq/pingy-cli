...
describe('baconize', () => {
  ...
  describe('preflight', () => {
    ...
    it('should work (basic test)', () => {
      return baconize.preflight(process.cwd()).then(info =>
    ...
    it('should have enoent output dir', () => {
      return baconize.preflight(process.cwd(), enoentDir).then(info =>
        expect(info, 'to have properties', {
          empty: false,
          exists: true,
          nodeModules: true,
    ...
    it('should have existing non-empty output dir', () => {
      return baconize.preflight(process.cwd(), existingDir).then((info) => {
        expect(info, 'to have properties', {
          empty: false,
          exists: true,
          nodeModules: true,
    ...
    it('should have existing empty output dir', () => {
      return baconize.preflight(process.cwd(), emptyDir).then(info =>
        expect(info, 'to have properties', {
          empty: false,
          exists: true,
          nodeModules: true,
